...
/**
 * Marks a method to be executed before the container shuts down.
 *
 ...
 * </ul>
 *
 * <p>Executes right after {@code @OblivionPreDestroy}.
 *
 * @see com.br.oblivion.annotations.OblivionPreDestroy
 */
...
public @interface OblivionPreShutdown {
   ...
   *
   * <p>In the 'cond' field we would use it like this: {@code @OblivionPreShutdown(cond =
   * "ENV.PROD")}.
   *
