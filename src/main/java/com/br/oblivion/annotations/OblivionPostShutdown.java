...
/**
 * Marks a method to be executed after the container is shuts down.
 *
 * <p>This is the last phase.
 *
 ...
 * </ul>
 *
 * <p>Executes right after {@code @OblivionPreShutdown}.
 *
...
public @interface OblivionPostShutdown {
   ...
   *
   * <p>In the 'cond' field we would use it like this: {@code @OblivionPostShutdown(cond =
   * "ENV.PROD")}.
   *
   ...
   * run asynchronously.
   *
   * <p>Usage: {@code @OblivionPostShutdown(async = true)}.
   *
